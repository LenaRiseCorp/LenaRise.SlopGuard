...
import {
  ...
  PROSE_EXTENSIONS, CODE_EXTENSIONS, STYLE_EXTENSIONS, MARKUP_EXTENSIONS,
...
export function classify(filePath) {
  ...
  if (STYLE_EXTENSIONS.includes(ext)) return 'style';
  if (MARKUP_EXTENSIONS.includes(ext)) return 'markup';
  return 'other';
}
