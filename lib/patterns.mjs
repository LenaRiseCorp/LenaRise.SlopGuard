...
export const PATTERNS = [
  ...
  },
  {
    ...
    match: /\b(?:api[_-]?key|secret|token|password|passwd|access[_-]?key)\s*[:=]\s*['"][A-Za-z0-9_\-./+]{16,}['"]/gi,
  ...
  },
  {
    ...
    match: /\b(?:tahmini|süre|ETA|estimated?|takes about|yaklaşık)\b[^\n]{0,40}\b\d+[-–]?\d*\s*(?:saat|gün|hafta|dakika|hours?|days?|weeks?|minutes?)\b/gi,
